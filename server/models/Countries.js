...
function createDefaultCountries() {
    Country.find({}).exec(function (err, collection) {
        if (collection.length === 0) {
            ...
            // Country.create({'country': 'Aland Islands', 'country_ID': 'ALA', 'iso2': 'AX'});
            Country.create({'country': 'Albania', 'country_ID': 'ALB', 'iso2': 'AL'});
            Country.create({'country': 'Algeria', 'country_ID': 'DZA', 'iso2': 'DZ'});
            // Country.create({'country': 'American Samoa', 'country_ID': 'ASM', 'iso2': 'AS'});
            // Country.create({'country': 'Andorra', 'country_ID': 'AND', 'iso2': 'AD'});
            Country.create({'country': 'Angola', 'country_ID': 'AGO', 'iso2': 'AO'});
            // Country.create({'country': 'Anguilla', 'country_ID': 'AIA', 'iso2': 'AI'});
            // Country.create({'country': 'Antarctica', 'country_ID': 'ATA', 'iso2': 'AQ'});
            ...
            // Country.create({'country': 'Bonaire, Sint Eustatius and Saba', 'country_ID': 'BES', 'iso2': 'BQ'});
            ...
            // Country.create({'country': 'Bouvet Island', 'country_ID': 'BVT', 'iso2': 'BV'});
            Country.create({'country': 'Brazil', 'country_ID': 'BRA', 'iso2': 'BR'});
            // Country.create({'country': 'British Indian Ocean Territory', 'country_ID': 'IOT', 'iso2': 'IO'});
            ...
            // Country.create({'country': 'Christmas Island', 'country_ID': 'CXR', 'iso2': 'CX'});
            // Country.create({'country': 'Cocos (Keeling) Islands', 'country_ID': 'CCK', 'iso2': 'CC'});
            ...
            // Country.create({'country': 'Cook Islands', 'country_ID': 'COK', 'iso2': 'CK'});
            ...
            // Country.create({'country': 'Curacao', 'country_ID': 'CUW', 'iso2': 'CW'});
            ...
            // Country.create({'country': 'Falkland Islands (Malvinas)', 'country_ID': 'FLK', 'iso2': 'FK'});
            // Country.create({'country': 'Faroe Islands', 'country_ID': 'FRO', 'iso2': 'FO'});
            ...
            // Country.create({'country': 'French Guiana', 'country_ID': 'GUF', 'iso2': 'GF'});
            // Country.create({'country': 'French Polynesia', 'country_ID': 'PYF', 'iso2': 'PF'});
            // Country.create({'country': 'French Southern Territories', 'country_ID': 'ATF', 'iso2': 'TF'});
            ...
            // Country.create({'country': 'Gibraltar', 'country_ID': 'GIB', 'iso2': 'GI'});
            ...
            // Country.create({'country': 'Guadeloupe', 'country_ID': 'GLP', 'iso2': 'GP'});
            Country.create({'country': 'Guam', 'country_ID': 'GUM', 'iso2': 'GU'});
            Country.create({'country': 'Guatemala', 'country_ID': 'GTM', 'iso2': 'GT'});
            // Country.create({'country': 'Guernsey', 'country_ID': 'GGY', 'iso2': 'GG'});
            ...
            // Country.create({'country': 'Heard Island and McDonald Islands', 'country_ID': 'HMD', 'iso2': 'HM'});
            // Country.create({'country': 'Holy See (Vatican City State)', 'country_ID': 'VAT', 'iso2': 'VA'});
            ...
            // Country.create({'country': 'Isle of Man', 'country_ID': 'IMN', 'iso2': 'IM'});
            ...
            // Country.create({'country': 'Jersey', 'country_ID': 'JEY', 'iso2': 'JE'});
            ...
            // Country.create({'country': 'Macao', 'country_ID': 'MAC', 'iso2': 'MO'});
            ...
            // Country.create({'country': 'Maldives', 'country_ID': 'MDV', 'iso2': 'MV'});
            Country.create({'country': 'Mali', 'country_ID': 'MLI', 'iso2': 'ML'});
            // Country.create({'country': 'Malta', 'country_ID': 'MLT', 'iso2': 'MT'});
            // Country.create({'country': 'Marshall Islands', 'country_ID': 'MHL', 'iso2': 'MH'});
            // Country.create({'country': 'Martinique', 'country_ID': 'MTQ', 'iso2': 'MQ'});
            Country.create({'country': 'Mauritania', 'country_ID': 'MRT', 'iso2': 'MR'});
            // Country.create({'country': 'Mauritius', 'country_ID': 'MUS', 'iso2': 'MU'});
            // Country.create({'country': 'Mayotte', 'country_ID': 'MYT', 'iso2': 'YT'});
            Country.create({'country': 'Mexico', 'country_ID': 'MEX', 'iso2': 'MX'});
            // Country.create({'country': 'Micronesia, Federated States of', 'country_ID': 'FSM', 'iso2': 'FM'});
            Country.create({'country': 'Moldova, Republic of', 'country_ID': 'MDA', 'iso2': 'MD'});
            // Country.create({'country': 'Monaco', 'country_ID': 'MCO', 'iso2': 'MC'});
            Country.create({'country': 'Mongolia', 'country_ID': 'MNG', 'iso2': 'MN'});
            Country.create({'country': 'Montenegro', 'country_ID': 'MNE', 'iso2': 'ME'});
            // Country.create({'country': 'Montserrat', 'country_ID': 'MSR', 'iso2': 'MS'});
            ...
            // Country.create({'country': 'Nauru', 'country_ID': 'NRU', 'iso2': 'NR'});
            Country.create({'country': 'Nepal', 'country_ID': 'NPL', 'iso2': 'NP'});
            Country.create({'country': 'Netherlands', 'country_ID': 'NLD', 'iso2': 'NL'});
            // Country.create({'country': 'New Caledonia', 'country_ID': 'NCL', 'iso2': 'NC'});
            ...
            // Country.create({'country': 'Niue', 'country_ID': 'NIU', 'iso2': 'NU'});
            // Country.create({'country': 'Norfolk Island', 'country_ID': 'NFK', 'iso2': 'NF'});
            // Country.create({'country': 'Northern Mariana Islands', 'country_ID': 'MNP', 'iso2': 'MP'});
            ...
            // Country.create({'country': 'Palau', 'country_ID': 'PLW', 'iso2': 'PW'});
            ...
            // Country.create({'country': 'Pitcairn', 'country_ID': 'PCN', 'iso2': 'PN'});
            ...
            // Country.create({'country': 'Reunion', 'country_ID': 'REU', 'iso2': 'RE'});
            ...
            // Country.create({'country': 'Saint Barthelemy', 'country_ID': 'BLM', 'iso2': 'BL'});
            // Country.create({'country': 'Saint Helena, Ascension and Tristan da Cunha', 'country_ID': 'SHN', 'iso2': 'SH'});
            // Country.create({'country': 'Saint Kitts and Nevis', 'country_ID': 'KNA', 'iso2': 'KN'});
            // Country.create({'country': 'Saint Lucia', 'country_ID': 'LCA', 'iso2': 'LC'});
            // Country.create({'country': 'Saint Martin (French part)', 'country_ID': 'MAF', 'iso2': 'MF'});
            // Country.create({'country': 'Saint Pierre and Miquelon', 'country_ID': 'SPM', 'iso2': 'PM'});
            // Country.create({'country': 'Saint Vincent and the Grenadines', 'country_ID': 'VCT', 'iso2': 'VC'});
            // Country.create({'country': 'Samoa', 'country_ID': 'WSM', 'iso2': 'WS'});
            // Country.create({'country': 'San Marino', 'country_ID': 'SMR', 'iso2': 'SM'});
            ...
            // Country.create({'country': 'Sint Maarten (Dutch part)', 'country_ID': 'SXM', 'iso2': 'SX'});
            Country.create({'country': 'Slovakia', 'country_ID': 'SVK', 'iso2': 'SK'});
            Country.create({'country': 'Slovenia', 'country_ID': 'SVN', 'iso2': 'SI'});
            // Country.create({'country': 'Solomon Islands', 'country_ID': 'SLB', 'iso2': 'SB'});
            Country.create({'country': 'Somalia', 'country_ID': 'SOM', 'iso2': 'SO'});
            Country.create({'country': 'South Africa', 'country_ID': 'ZAF', 'iso2': 'ZA'});
            // Country.create({'country': 'South Georgia and the South Sandwich Islands', 'country_ID': 'SGS', 'iso2': 'GS'});
            ...
            // Country.create({'country': 'Svalbard and Jan Mayen', 'country_ID': 'SJM', 'iso2': 'SJ'});
            ...
            // Country.create({'country': 'Tokelau', 'country_ID': 'TKL', 'iso2': 'TK'});
            // Country.create({'country': 'Tonga', 'country_ID': 'TON', 'iso2': 'TO'});
            ...
            // Country.create({'country': 'Turks and Caicos Islands', 'country_ID': 'TCA', 'iso2': 'TC'});
            // Country.create({'country': 'Tuvalu', 'country_ID': 'TUV', 'iso2': 'TV'});
            ...
            // Country.create({'country': 'United States Minor Outlying Islands', 'country_ID': 'UMI', 'iso2': 'UM'});
            Country.create({'country': 'Uruguay', 'country_ID': 'URY', 'iso2': 'UY'});
            Country.create({'country': 'Uzbekistan', 'country_ID': 'UZB', 'iso2': 'UZ'});
            // Country.create({'country': 'Vanuatu', 'country_ID': 'VUT', 'iso2': 'VU'});
            ...
            // Country.create({'country': 'Virgin Islands, British', 'country_ID': 'VGB', 'iso2': 'VG'});
            // Country.create({'country': 'Virgin Islands, U.S.', 'country_ID': 'VIR', 'iso2': 'VI'});
            // Country.create({'country': 'Wallis and Futuna', 'country_ID': 'WLF', 'iso2': 'WF'});
            // Country.create({'country': 'Western Sahara', 'country_ID': 'ESH', 'iso2': 'EH'});

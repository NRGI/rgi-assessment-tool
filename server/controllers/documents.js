...
var crypto                 = require('crypto'),
    ...
    client                 = s3.createClient({
                                ...
                                s3Options: {
                                    accessKeyId: 'AKIAJCWCQOFRXZYSRWJA',
                                    secretAccessKey: '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'
...
exports.getDocumentsByID = function (req, res) {
    Document.findOne({assessment_ID: req.params.assessment_ID}).exec(function (err, document) {
        res.send(document);
    });
};

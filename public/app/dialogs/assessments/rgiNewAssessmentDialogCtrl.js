...
angular.module('app')
    .controller('rgiNewAssessmentDialogCtrl', function (
        ...
        $scope.assessmentDeploy = function () {
            ...
            rgiQuestionSrvc.query({assessments: new_assessment_year + "-" + new_assessment_ver}, function (assessments) {
                var country_deployed = false;
                console.log(assessments);
                console.log($scope.new_assessment.assessment_countries);
                //assessments.forEachKey(function (assessment) {

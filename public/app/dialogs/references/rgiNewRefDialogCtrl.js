...
angular
    ...
    .controller('rgiNewRefDialogCtrl', function (
        ...
        $scope.newInterviewee = function () {
            //$scope.new_human_form.$setPristine();
            $scope.new_interviewee = {};
            ////$scope.selected_interviewee = '';
            delete $scope.selected_interviewee.title;
            //$scope.selected_interviewee = undefined;
        };


        //$scope.newInterviewee = function () {
        //    $scope.auto_complete = false;
        //};
        //
        //$scope.existingInterviewee = function () {
        //    $scope.auto_complete = true;
        //};

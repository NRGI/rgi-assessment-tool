'use strict';
angular.module('app').controller('rgiAssessmentDetailTableCtrl', function ($scope, rgiQuestionSrvc) {
    var questions;
    ...
    var getAnsweredOptions = function() {
        ...
        $scope.answers.forEach(function(answer) {
            if(answer.researcher_score) {
                options.push(getOption(getQuestion(answer).question_choices, answer.researcher_score)._id);
            }
        });
